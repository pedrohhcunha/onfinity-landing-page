            ...
            <div className={styles.footerPrimary}>
                ...
                <div className={styles.areaInfo}>
                    ...
                    <ul className={`${styles.socialMedias} ${styles.list}`}>
                        ...
                        <li className={styles.item}>
                            <a target="_blank" rel="noreferrer" aria-label='Link Instagram Onfinity' href="https://www.instagram.com/" className={styles.link}>
                        ...
                        <li className={styles.item}>
                            <a target="_blank" rel="noreferrer" aria-label='Link Linkedin Onfinity' href="https://www.linkedin.com/company/69572341/admin/" className={styles.link}>
                                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
