            ...
            <div className={styles.footerPrimary}>
                ...
                <div className={styles.areaInfo}>
                    ...
                    <ul className={`${styles.socialMedias} ${styles.list}`}>
                        ...
                        <li className={styles.item}>
                            <a target="_blank" rel="noreferrer" aria-label='Link Instagram Onfinity' href="https://www.instagram.com/onfinity_/" className={styles.link}>
                        ...
                        <li className={styles.item}>
                            <a target="_blank" rel="noreferrer" aria-label='Link Linkedin Onfinity' href="https://www.linkedin.com/company/onfinity/" className={styles.link}>
                                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className={styles.item}>
                            <a target="_blank" rel="noreferrer" aria-label='Link Youtube Onfinity' href="https://www.youtube.com/channel/UCJcNEbd45CSj6NxQie03ENw" className={styles.link}>
                                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={styles.footerSecondary}>
                ...
                <div className={styles.areaInfo}>
                    ...
                    <address className={styles.paragraph}>
                        Avenida Porto Alegre 427 D Centro |  Chapecó |  SC <br /> Sala 505 e 506
                    </address>
                </div>
            </div>
