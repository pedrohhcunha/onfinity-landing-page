            ...
            <div className={styles.footerPrimary}>
                ...
                <div className={styles.areaInfo}>
                    ...
                    <ul className={`${styles.socialMedias} ${styles.list}`}>
                        <li className={styles.item}>
                            <a href="https://www.facebook.com/Onfinity-101644625222997" className={styles.link}>
                        ...
                        <li className={styles.item}>
                            <a href="" className={styles.link}>
                                ...
                                <span style={{
                                    display: 'none',
                                }}>Link Instagram Onfinity</span>
                            </a>
                        </li>
                        <li className={styles.item}>
                            <a href="https://www.linkedin.com/company/69572341/admin/" className={styles.link}>
                                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span style={{
                                    display: 'none',
                                }}>Link Linkedin Onfinity</span>
                            </a>
                        </li>
                        <li className={styles.item}>
                            <a href="https://www.youtube.com/channel/UCJcNEbd45CSj6NxQie03ENw" className={styles.link}>
                                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
